      ...
      <div className='container' style={{ width: '75%', float: 'right' }}>
        ...
        <div className='input-group mb-3' style={{ width: '75%', float: 'right', marginTop: '50px' }} >
          ...
          <div style={{width:'50%',float:'right'}}>
            ...
            onClick={genReport} 
            style={{ backgroundColor: '#065A82', color: 'white' }}>Generate Inventory Report</button>
            ...
            <tbody>
              ...
              {searchResults.map((course) => (
                <tr key={course._id}>
                  ...
                  <td>
                    <Link to='/allCourse/editCourse'><button className='btn btn-info' type='button' id='EditButton' style={{ backgroundColor: '#9EB3C2' }} onClick={handleDestination}>Edit</button></Link>
                  </td>
                  <td>
                    <button className='btn btn-danger' type='button' id='DeleteButton' onClick={() => deleteCourse(course.courseID)}>Delete</button>
                  </td>
                </tr>
              ))}
